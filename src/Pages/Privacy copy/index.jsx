      ...
      <div className="terms-privacy-container">
        ...
        <div className="main-content-bx">
          ...
          <div className="main-bdy-txt">
            ...
            information about your device and usage of our Platform, including
            IP addresses, browser type, and referral URLs. <br />
            <br /> General Data: The use of our services will automatically
            create information that will be collected. For example, when you use
            our Services, your geographic location, how you use the Services,
            ...
            applications, we gather certain information automatically and store
            it in log files. This information includes but is not limited to IP
            ...
            Site. Analytics services use Cookies to collect information such as
            how often users visit the Site and we use the information to improve
            our Site and Services. The analytics services' ability to use and
            share information collected by them is restricted by their terms of
            use and privacy policy, which you should refer to for more
            information about how these entities use this information. <br />
            ...
            files) that a website sends to your computer’s hard drive while you
            are viewing the website. These text files can be used by websites to
            make the user experience more efficient. The law states that we can
            store these cookies on your device if they are strictly necessary
            for the operation of this site. For all other types of cookies we
            need your permission. To that end, this site uses different types of
            cookies. Some cookies are placed by third party services that appear
            on our pages. We and some third parties may use both session Cookies
            (which expire once you close your web browser) and persistent
            Cookies (which stay on your computer until you delete them) to
            provide you with a more personal and interactive experience on our
            Services and to market the Services or other products. Marketing
            cookies are used to track visitors across websites. The intention is
            to display ads that are relevant and engaging for the individual
          ...
          <div className="main-bdy-txt">
            ...
            and communicate with you. We may use your information to improve our
            ...
            enhance the content of our Services and improve Site functionality.
            We reserve the right to use anonymous data for any purpose and
          ...
          <div className="main-bdy-txt">
            ...
            assurance testing; to provide technical support; market the
            Services; and/or to provide other services to us.
            <br />
            <br /> Information We Share: We may disclose aggregated information
            about our users and information that does not identify any
            individual without restriction. In addition, we may disclose
            ...
            Personal information if it believes in good faith that such
            disclosure is necessary: (i) in connection with any legal
            ...
            <br /> <br /> defend the rights or property of Herrands or users of
            the Services; and/or (iv) to investigate or assist in preventing any
          ...
          <div className="main-bdy-txt">
            ...
            or Services and go to another site, and another entity may collect
            ...
            our endorsement of such third parties or their products, content or
            websites.
          </div>
          ...
          <div className="main-bdy-txt">
            ...
            directly. Despite your indicated email preferences, we may send you
          ...
          <div className="main-bdy-txt">
            ...
            <ul>
              <li>
                ...
                any time. Extra requests (particularly repetitive) for data may
          ...
          <div className="main-bdy-txt">
            ...
            form that allows for identification only for as long as: <br />
            <br />
            <ol type="i">
              <li>
          ...
          <div className="main-bdy-txt">
            ...
            your information when you use our mobile application ("App"). <br />
          ...
          <div className="main-bdy-txt">
            ...
            <ul className="weinfo">
              <br />
              <li>
                Access: You can request access to your personal data and receive
                a copy.
              </li>
              <li>
