        ...
        <div class="content sm:w-[80%] w-[95%] py-24 text-justify">
          ...
          <div class="py-4">
            ...
            <p>
              ...
              that will enable our agents to provide exceptional services to our
              valued customers. To ensure a smooth experience for you while running
              errands on our platform, please adhere to the following guidelines
              that covers code of conduct, safety measures and how we protect you:
            </p>
          </div>
          ...
          <div class="py-4">
            <span class="flex">
              <p>
                ...
                customers using our platform to ensure a safe working environment. In addition, 
                there are regular training sessions on safety protocols and best practices.
              </p>
            </span>
          </div>
          ...
          <div class="py-4">
            <span class="flex">
              <p>
                {" "}
                <b>Reporting: </b>If you encounter any issues, concerns, or suspicious 
                activity that can endanger you or threaten your safety, please report them 
                to our support team immediately. We are here to assist you 24/7.
              </p>
            </span>
          </div>
          ...
          <div class="py-4">
            <span class="flex">
              <p>
                {" "}
                <b>Dispute Resolution: </b> In case of disputes or conflicts, remember 
                that open communication is key. Try to resolve issues directly with the customer. 
                If a resolution cannot be reached, or if you have any questions about 
                these guidelines and general operations of our time-sharing platform, 
          ...
          <div class="py-4">
            <span class="flex">
              <p>
                Thank you for choosing to work with us in pursuit of our dreams to make the 
                world a better place by providing decent work and economic growth. You have 
                our best wishes 🎉🎊.              
              </p>
            </span>
          </div>
