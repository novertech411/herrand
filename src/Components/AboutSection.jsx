    ...
    <div>
      ...
      >
        <div className="left-side-about">
          ...
          >
            <iframe
              ...
              src="https://www.youtube.com/embed/B4SSA8l4kwM"
        ...
        <div className="right-side-about ">
          ...
          <div className=" text-[18px] text-gray-500 pr-11 py-8">
            ...
            connects you with reliable runners who will run your errands, so you
            can avoid the stress of juggling multiple errands all alone and make
            time for what matters to you. Whether it’s picking up your items or
            returning packages, last-minute delivery, doing household chores,
            having someone follow you to run errands together, intercepting
            buses...
          </div>
          <ScrollLink
            to="download-section"
      ...
      >
        <div className="right-side-about">
          ...
          <div className=" text-[18px] text-gray-500 pr-11 py-8 ">
            ...
            complementary needs – You, the sender, who needs to send someone on
            errands, and our vetted runners, who are available on-demand to run
            your errands. The result is a win-win partnership where everyone
            benefits by making time for what matters to them.
          </div>
